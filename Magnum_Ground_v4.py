...
plt.figure(21)
plt.title( "Pressurant regulator outlet pressures")
plt.plot(time, array(P2pres_fuel)/psi, label = "Fuel pressurant" )
plt.plot(time, array(Pfueltank)/psi, label = "Fuel tank" )
plt.plot(time, array(P2pres_ox)/psi, label = "Ox pressurant" )
plt.plot(time, array(Poxtank)/psi, label = "Ox tank" )
plt.xlabel('Time [s]')
plt.ylabel('psi')
